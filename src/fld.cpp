...
void Fluid::outputManiz(double tau, double psi1, double psi2, double psi3, double psi4, double psi5, double psi6, double psi7, double psi8, double psi9, double psi10) {
